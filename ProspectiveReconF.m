...
load('./data/Prospective/ksDataSmaps_F_Invivo_Mprage_prospective_Acc1_subj2.mat')
ksDataFull = ksData./max(abs(ksData(:)));
%%% ------ Load under sampled k-space data ------ %%%
load('./data/Prospective/ksDataSmaps_F_Invivo_Mprage_prospective_Acc5_subj2.mat');
