...
load('./data/mask/optFmask5_1.mat')
r = find(mask(:,1)==1);
Fu = F(r,:);

%%% ------ Load k-space data ------ %%%
load('./data/Retrospective/RetroksDataSmapsMprageSag_F_1.mat')
S = SCalib;
...
%%% ------ L1 Recon Parameters ------ %%% 
TVWeight = 0.004; 	% Weight for TV penalty %%% 0.001 for GRE and 0.004 for MPRAGE
xfmWeight = 0.004;	% Weight for Transform L1 penalty  %%% 0.001 for GRE and 0.004 for MPRAGE
